 ...
 * limitations under the License.
 */
var qt="firebase-heartbeat-store",zt=null;function Wt(){return zt||(zt=bt("firebase-heartbeat-database",1,{upgrade:function(e,t){if(0===t)e.createObjectStore(qt)}}).catch((function(e){throw Ut.create("idb-open",{originalErrorMessage:e.message})}))),zt}function Jt(e){return Gt.apply(this,arguments)}function Gt(){return(Gt=e(o)(e(P).mark((function t(r){var n,i,a;return e(P).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=1,e.next=4,Wt();case 4:return i=e.sent,e.abrupt("return",i.transaction(qt).objectStore(qt).get(Xt(r)));case 8:e.prev=8,e.t0=e.catch(1),e.t0 instanceof Me?Rt.warn(e.t0.message):(a=Ut.create("idb-get",{originalErrorMessage:null===(n=e.t0)||void 0===n?void 0:n.message}),Rt.warn(a.message));case 11:case"end":return e.stop()}}),t,null,[[1,8]])})))).apply(this,arguments)}function Kt(e,t){return Yt.apply(this,arguments)}function Yt(){return(Yt=e(o)(e(P).mark((function t(r,n){var i,a,o,s,u;return e(P).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=1,e.next=4,Wt();case 4:return a=e.sent,o=a.transaction(qt,"readwrite"),s=o.objectStore(qt),e.next=9,s.put(n,Xt(r));case 9:return e.abrupt("return",o.done);case 12:e.prev=12,e.t0=e.catch(1),e.t0 instanceof Me?Rt.warn(e.t0.message):(u=Ut.create("idb-set",{originalErrorMessage:null===(i=e.t0)||void 0===i?void 0:i.message}),Rt.warn(u.message));case 15:case"end":return e.stop()}}),t,null,[[1,12]])})))).apply(this,arguments)}function Xt(e){return"".concat(e.name,"!").concat(e.options.appId)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */er="",Mt(new Ke("platform-logger",(function(e){return new Et(e)}),"PRIVATE")),Mt(new Ke("heartbeat",(function(e){return new $t(e)}),"PRIVATE")),Vt(St,Ot,er),Vt(St,Ot,"esm2017"),Vt("fire-js","");
/**
 * @license
 ...
 * limitations under the License.
 */
e(o)(e(P).mark((function t(r,n){return e(P).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",jr(r,"POST","/v1/accounts:signInWithEmailLink",Nr(r,n)));case 1:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function Vn(e,t){return qn.apply(this,arguments)}function qn(){return(qn=e(o)(e(P).mark((function t(r,n){return e(P).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",jr(r,"POST","/v1/accounts:signInWithEmailLink",Nr(r,n)));case 1:case"end":return e.stop()}}),t)})))).apply(this,arguments)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Fa={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Ha="_blank",Va="http://localhost",qa=function(){"use strict";function t(r){e(u)(this,t),this.window=r,this.associatedEvent=null}return e(_)(t,[{key:"close",value:function(){if(this.window)try{this.window.close()}catch(e){}}}]),t}();function za(t,r,n){var i=arguments.length>3&&void 0!==arguments[3]?arguments[3]:500,a=arguments.length>4&&void 0!==arguments[4]?arguments[4]:600,o=Math.max((window.screen.availHeight-a)/2,0).toString(),s=Math.max((window.screen.availWidth-i)/2,0).toString(),u="",c=Object.assign(Object.assign({},Fa),{width:i.toString(),height:a.toString(),top:o,left:s}),l=Ne().toLowerCase();n&&(u=wn(l)?Ha:n),bn(l)&&(r=r||Va,c.scrollbars="yes");var f=Object.entries(c).reduce((function(t,r){var n=e(pe)(r,2),i=n[0],a=n[1];return"".concat(t).concat(i,"=").concat(a,",")}),"");if(Sn(l)&&"_self"!==u)return Wa(r||"",u),new qa(null);var h=window.open(r||"",u,f);yr(h,t,"popup-blocked");try{h.focus()}catch(e){}return new qa(h)}function Wa(e,t){var r=document.createElement("a");r.href=e,r.target=t;var n=document.createEvent("MouseEvent");n.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),r.dispatchEvent(n)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Za)),Vt(eo,to,"esm2017");var io=new oi,ao=(function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};if("object"!=typeof t){var r=t;t={name:r}}var n=Object.assign({name:Pt,automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw Ut.create("bad-app-name",{appName:String(i)});var a=Ct.get(i);if(a){if(Fe(e,a.options)&&Fe(n,a.config))return a;throw Ut.create("duplicate-app",{appName:i})}var o=new Ze(i),s=!0,u=!1,c=void 0;try{for(var l,f=Lt.values()[Symbol.iterator]();!(s=(l=f.next()).done);s=!0){var h=l.value;o.addComponent(h)}}catch(e){u=!0,c=e}finally{try{s||null==f.return||f.return()}finally{if(u)throw c}}var p=new jt(e,n,o);Ct.set(i,p)}({apiKey:"AIzaSyC-rMEvEUJ6DbhIaJz-m19MpHLMzbQ1hi4",authDomain:"auth-9127f.firebaseapp.com",projectId:"auth-9127f",storageBucket:"auth-9127f.appspot.com",messagingSenderId:"1077758083281",appId:"1:1077758083281:web:0634a927ba2da6007f85f0"}),document.querySelector(".header__btn-signup")),oo=document.querySelector(".header__btn-container");ao.addEventListener("click",(function(){ca(no(),io).then((function(e){oi.credentialFromResult(e).accessToken;var t=e.user;console.log(t),localStorage.setItem(t.email,t.displayName),t.email&&(ao.classList.add("is-hidden"),oo.innerHTML='<a class="header__ref header__singup-link header__btn-signup" style="font-size">'.concat(t.displayName,"</a>"))})).catch((function(e){e.code,e.message,e.customData.email,oi.credentialFromError(e)}))}));var so={openModalBtn:document.querySelector(".footer-link"),closeModalBtn:document.querySelector("[data-modal-close-contacts]"),backdrop:document.querySelector(".backdrop__modal")};function uo(){so.backdrop.classList.add("is-hidden"),window.removeEventListener("keydown",co)}function co(e){27===e.keyCode&&uo()}so.openModalBtn.addEventListener("click",(function(){so.backdrop.classList.remove("is-hidden"),window.addEventListener("keydown",co)})),so.closeModalBtn.addEventListener("click",uo),so.backdrop.addEventListener("click",(function(e){e.target.classList.contains("js-close-modal")&&uo()}));var lo=document.querySelector(".scroll-btn");window.addEventListener("scroll",(function(){window.pageYOffset>100?lo.classList.add("is-activ"):lo.classList.remove("is-activ")}));var fo=document.querySelector(".movie-cards__list"),ho=document.querySelector(".modal"),po=document.querySelector(".modal-inner"),vo=document.querySelector(".btn-close");document.querySelector("body");fo.addEventListener("click",(function(e){var t=e.target.closest("li").id;ne.fetchDetails(t).then((function(e){mo(e)}))}));var mo=function(e){var t,r,n=e.id,i=e.poster_path,a=e.original_title,o=e.genres,s=e.vote_average,u=e.popularity,c=e.overview,l=e.vote_count,f=o.map((function(e){return e.name})).join(", ")||"Genres are not specified",h=i?"https://image.tmdb.org/t/p/w500".concat(i):"",p=null!==(t=localStorage.getItem("watched"))&&void 0!==t?t:"[]",d=JSON.parse(p).some((function(e){return e.id===n})),v=null!==(r=localStorage.getItem("queue"))&&void 0!==r?r:"[]",m=JSON.parse(v).some((function(e){return e.id===n})),g="<li id='".concat(n,'\' class="movies__item">\n  <img class="movie-modal__img" src="').concat(h,'" alt="').concat(a,'">\n    <div class="movies__wrapper">\n        <h2 class="movie-modal__name">').concat(a,'</h2>\n        <div class="movies__wrapper--data">\n            <table class="movie-modal__table">\n                        <tr>\n                            <td class="movie-modal__text">Vote / Votes</td>\n                            <td class="movie-modal__numbers"><span class="movie-modal__vote">').concat(s,' </span> / <span class="movie-modal__votes">').concat(l,'</span></td>\n                        </tr>\n                        <tr>\n                            <td class="movie-modal__text">Popularity</td>\n                            <td class="movie-modal__numbers">').concat(u,'</td>\n                        </tr>\n                    \n                        <tr>\n                            <td class="movie-modal__text">Original Title</td>\n                            <td class="movie-modal__numbers">').concat(a,'</td>\n                        </tr>\n                        <tr>\n                            <td class="movie-modal__text">Genre</td>\n                            <td class="movie-modal__numbers">').concat(f,'</td>\n                        </tr>\n                    </table>\n\n           \n            <article class="movie-modal__article">\n            <p class="movie-overview__title">ABOUT</p>\n            <p class="movie-overview__text">').concat(c,'</p>\n            </article>\n            <div class="btn-container">\n             <button class="btn-watched" data-btnModal="watched">').concat(d?"Remove from watched":"add to Watched",'</button>\n            <button class="btn-queue" data-btnModal="queue">').concat(m?"Remove from queue":"add to queue","</button>\n            </div>\n            </div>\n        </div>\n    </li>");po.insertAdjacentHTML("afterbegin",g),ho.classList.add("is-open"),document.addEventListener("keydown",yo)};function go(){ho.classList.remove("is-open"),po.innerHTML="",document.removeEventListener("keydown",yo)}function yo(e){"Escape"===e.key&&(document.removeEventListener("keydown",yo),go())}vo.addEventListener("click",go),ho.addEventListener("click",(function(e){"modal is-open"===e.target.className&&go()}));var bo=localStorage.getItem("films"),_o=JSON.parse(bo),wo=localStorage.getItem("queue"),ko=JSON.parse(wo),xo=null!=ko?ko:[],Eo=localStorage.getItem("watched"),Io=JSON.parse(Eo),To=null!=Io?Io:[];po.addEventListener("click",(function(e){var t=e.target.closest("li").id;if("btn-watched"===e.target.className){var r=document.querySelector('[data-btnModal="watched"]'),n=_o.find((function(e){return e.id===Number(t)}));if(!n)return;var i=To.findIndex((function(e){return e.id===n.id}));-1===i?(r.textContent="Remove from watched",To.push(n)):(r.textContent="add to Watched",To.splice(i,1)),localStorage.setItem("watched",JSON.stringify(To))}if("btn-queue"===e.target.className){var a=document.querySelector('[data-btnModal="queue"]'),o=_o.find((function(e){return e.id===Number(t)}));if(!o)return;var s=xo.findIndex((function(e){return e.id===o.id}));-1===s?(a.textContent="Remove from queue",xo.push(o)):(a.textContent="Add to queue",xo.splice(s,1)),localStorage.setItem("queue",JSON.stringify(xo))}}));var So={body:document.querySelector("body"),container:document.querySelector(".theme__container"),sunLogo:document.querySelector(".sun-logo"),moonLogo:document.querySelector(".moon-logo"),footer:document.querySelector(".footer-container")},Oo=localStorage.getItem("darkMode"),Ro=function(){So.body.classList.add("dark"),So.footer.classList.add("dark"),So.sunLogo.classList.toggle("animate-sun"),So.moonLogo.classList.toggle("animate-moon"),localStorage.setItem("darkMode","enabled")};"enabled"===Oo&&Ro(),So.container.addEventListener("click",(function(){"enabled"!==(Oo=localStorage.getItem("darkMode"))?Ro():(So.body.classList.remove("dark"),So.footer.classList.remove("dark"),So.sunLogo.classList.toggle("animate-sun"),So.moonLogo.classList.toggle("animate-moon"),localStorage.setItem("darkMode","disabled"))}))}();
//# sourceMappingURL=index.2e64ff28.js.map
